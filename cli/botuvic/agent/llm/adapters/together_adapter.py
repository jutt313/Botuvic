"""
Together AI adapter - OpenAI-compatible API.
"""
...
class TogetherAdapter(BaseLLMAdapter):
    ...
    def get_available_models(self) -> List[Dict[str, Any]]:
        ...
        return [
            {"id": "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo", "name": "Llama 3.1 405B Turbo", "provider": "Together"},
            {"id": "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo", "name": "Llama 3.1 70B Turbo", "provider": "Together"},
            ...
            {"id": "Qwen/Qwen2.5-72B-Instruct-Turbo", "name": "Qwen 2.5 72B", "provider": "Together"},
        ]
